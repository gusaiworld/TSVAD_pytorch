...
if [ $START_STAGE -le 1 ] && [ $END_STAGE -ge 1 ]; then
    ...
    if [ ! -z "$GROUNDTRUTH_RTTM" ]; then
        ...
        ./md-eval.pl -c 0.25 -s "${DATA_PATH}/rttm/computed_rttm_vbx.rttm" -r "$GROUNDTRUTH_RTTM"
        ./md-eval.pl -c 0.00 -s "${DATA_PATH}/rttm/computed_rttm_vbx.rttm" -r "$GROUNDTRUTH_RTTM"
        cd ../../../../../
